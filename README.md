...
- **Recurring notes themes** — if a word or short phrase shows up in your personal notes across 2 or more trades (e.g. "felt rushed", "confirmation"), you get notified on the Journal view, with a full ranked list on the Dashboard.
